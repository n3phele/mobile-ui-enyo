enyo.kind({
	...
	components: [
		{layoutKind: "FittableRowsLayout", components: [
			...
			{kind: "onyx.Toolbar", style:"margin:25px 0 25px 0;width:50%;border-radius:6px 6px", components: [
				{kind: "onyx.InputDecorator",style: "width: 85%;", layoutKind: "FittableColumnsLayout", components: [
					{name: "searchInput", fit: true, /* content: "search",  */ kind: "onyx.Input", onchange: "search"},
			...
			//{kind: "onyx.Toolbar", content: "New Stack", name: "title_2", style:"background:#b1c2d7;border:1px solid #375d8c;background-size:contain;color:#375d8c"},
			{kind: "List", fit: true, touch: true,style:"border: 1px solid #375D8C", onSetupItem: "setupItem", components: [
				...
				/* {name: "more", style: "background-color: #323232;", components: [
					...
					{name: "moreSpinner", kind: "Image", src: "http://nightly.enyojs.com/latest/sampler/assets/spinner.gif", classes: "panels-sample-flickr-more-spinner"}
				]} */
			]}			
		]},
		...
		{name: "pictureView", fit: true, kind: "FittableRows", classes: "enyo-fit panels-sample-flickr-main", components: [
			...
			{fit: true, style: "position: relative;", components: [
				...
				{name: "imageSpinner", kind: "Image", src: "http://nightly.enyojs.com/latest/sampler/assets/spinner-large.gif", classes: "enyo-fit panels-sample-flickr-center", showing: false}
			]}
		]},
